...
elgg_register_event_handler('init','system','argon_theme_init');

function argon_theme_init() {

	elgg_register_event_handler('pagesetup', 'system', 'argon_theme_pagesetup', 1000);

	// theme specific CSS
	elgg_extend_view('elgg.css', 'argon_theme/css');
 ...
 */
function argon_theme_pagesetup() {
 ...
 * @return array
 */
function argon_theme_setup_head($hook, $type, $data) {
	...
	$data['links']['apple-touch-icon'] = array(
		...
		'href' => elgg_get_simplecache_url('argon_theme/homescreen.png'),
	);
